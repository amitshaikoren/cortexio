...
def load_drivers(drivers_to_load):
    ...
    # For example if abosulte path is /home/user/PycharmProjects/cortexio/cortexio/frontend/network/client/utils/reader.py
    # then we will generate cortexio.frontend.network.client.utils
